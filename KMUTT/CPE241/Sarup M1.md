```sql
-- ex. CREATE DATABASE ihavenolifeihateblackpeople; 
CREATE TABLE <name>( 
	<attribute> <type> <condition ex. PRIMARY KEY, NOT NULL, UNIQUE, DEFAULT = "Nigga"> 
...
CREATE TABLE <m-m_table_something_nigga>( 
	<1st_table_id> 
	<2nd_table_id> 
...
-- ex. INSERT INTO Students(firstname, lastname) VALUES ('hairy', 'nigga'); 
...
-- ex. UPDATE Students SET firstname = "Moya", lastname = "Nigga" WHERE id = 1; 
